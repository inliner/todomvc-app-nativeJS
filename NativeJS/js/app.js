window.mytodoApp = (function(window) {
    'use strict';
    ...
    function doTheStuff(selector) {
        var LOCALSTORAGE_KEY = 'storeTodo' + selector.replace(/\./g, ''),
            todoList = JSON.parse(localStorage.getItem(LOCALSTORAGE_KEY)) || [],
            appContainer = document.querySelector(selector),
            todoListElement = appContainer.querySelector('.todo-list'),
            mainSection = appContainer.querySelector('.main'),
            footer = appContainer.querySelector('.footer'),
            input = appContainer.querySelector('.new-todo'),
            ...
            deleteElement = appContainer.querySelectorAll('destroy'),
        ...
        function bindListeners() {
            ...
            todoListElement.addEventListener('click', deleteTodoRecord, false);
        };
...
mytodoApp.init('.maketodo1');
mytodoApp.init('.maketodo2');